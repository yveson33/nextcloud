...
class DockerServiceManager:
    ...
    def __init__(self, base_path: str = None):
        ...
        self.services: Dict[str, Path] = {
            ...
            "syncthing": self.current_path / "docker/syncthing"
        }
    ...
    def manage_all_services(self, action: str) -> bool:
        ...
        success = True
        services_list = ["immich", "portainer", "syncthing"]
...
def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Actions disponibles:
  start      - Démarrer les services par défaut (immich, portainer, syncthing)
...
Services gérés par défaut:
  ...
  • syncthing: ./docker/syncthing (dépôt des photos du mobile)
